/**
 * Example plugins seeded into an empty plugins directory on first run (disabled by default).
 * They double as living documentation — see PLUGINS.md.
 */
...
const TOOL_GUARD = `// Kravn example plugin — an Apigee-style request/response hook.
...
export const SEED_PLUGINS: SeedPlugin[] = [
  { id: 'tool-guard', filename: 'tool-guard.mjs', source: TOOL_GUARD },
];
