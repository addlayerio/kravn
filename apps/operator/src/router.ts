...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/oauth/consent', name: 'oauth-consent', component: () => import('./views/OAuthConsentView.vue') },
  {
    ...
    children: [
      ...
      { path: 'virtual-servers/new', name: 'virtual-server-new', component: () => import('./views/VirtualServerEditView.vue'), meta: { permission: 'virtualservers.write' } },
      { path: 'virtual-servers/:id', name: 'virtual-server-edit', component: () => import('./views/VirtualServerEditView.vue'), meta: { permission: 'virtualservers.read' } },
